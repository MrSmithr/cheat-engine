...
begin
  ...
  script.add('');
  script.insert(0,'alloc('+result+',512)'); //Let's place bets how many people are going to remark that this is what breaks their code
                                            //and not because they didn't allocate enough memory properly...
